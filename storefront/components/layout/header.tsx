        ...
        <div className="container-custom">
          <div className="flex h-16 items-center justify-between gap-4">
            ...
            <Link href="/" className="flex items-center gap-2">
              <span className="font-heading text-3xl font-semibold tracking-wide italic">
                Luminae
              </span>
            </Link>
            ...
            <div className="flex items-center gap-1">
              ...
              >
                {isLoggedIn ? <User className="h-4.5 w-4.5" /> : <LogIn className="h-4.5 w-4.5" />}
              </Link>
              <button
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          >
            <div className="flex items-center justify-between p-4 border-b">
              <span className="font-heading text-2xl font-semibold italic">Luminae</span>
              <button
            ...
            <nav className="p-4 space-y-1">
              ...
              <div className="pt-4 space-y-1">
                <Link
                  href={isLoggedIn ? '/account' : '/auth/login'}
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block py-3 text-muted-foreground text-sm"
                >
