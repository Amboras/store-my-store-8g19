...
export const metadata: Metadata = {
  title: {
    default: 'Luminae — Handcrafted Luxury Candles',
    template: '%s | Luminae',
  },
  description: 'Handcrafted luxury candles made with premium natural wax and fine fragrance. Elevate every moment with Luminae.',
}
